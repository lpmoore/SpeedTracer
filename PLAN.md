...
### 3. Score ≥ 750 — Animated explosion
...
| Trigger | Sound idea |
|---|---|
| Score 750–799 | Small explosion crack |
| Score 800–849 | Bigger blast |
| Score 850–899 | Deep boom |
| Score 900–949 | Rumbling explosion |
| Score 950–999 | Ground-shaking detonation |
...
- Multi-circle scoring: score is the *average* of all circle scores in the round
...
- Badge awarded each time the player *passes* a level (promotion threshold hit).
